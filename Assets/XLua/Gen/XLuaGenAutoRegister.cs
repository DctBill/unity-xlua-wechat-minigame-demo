...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(LuaLogBridge), LuaLogBridgeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaGameEntry), LuaGameEntryWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaSaveBridge), LuaSaveBridgeWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(LuaGameSaveData), LuaGameSaveDataWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(ILuaGameApp), ILuaGameAppBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(ILuaGameState), ILuaGameStateBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(ILuaGameTexts), ILuaGameTextsBridge.__Create);
